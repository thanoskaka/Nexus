...
export const PROVIDER_DEFS: Record<ProviderCredentialId, {
  ...
  gemini: {
    label: 'Google Gemini',
    description: 'AI assistant, portfolio Q&A, and screenshot OCR',
    storageType: 'encrypted-server',
    signUpUrl: 'https://aistudio.google.com/apikey',
  },
  deepseek: {
    label: 'DeepSeek',
    description: 'Alternative AI provider for chat and reasoning',
    storageType: 'encrypted-server',
    signUpUrl: 'https://platform.deepseek.com/api_keys',
  },
  massive: {
    label: 'Massive',
    description: 'U.S. stock close-price data',
    storageType: 'local-only',
    signUpUrl: 'https://massive.com',
  },
  alpha_vantage: {
    label: 'Alpha Vantage',
    description: 'Stock/ETF price data and forex rates',
    storageType: 'local-only',
